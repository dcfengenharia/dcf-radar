...
use App\Observers\RecebimentoPedidoParcelaObserver;
...
use App\Observers\PedidoCompraPrevisaoEntregaObserver;
use App\Observers\RequisicaoCompraAdjudicacaoObserver;
use App\Observers\RequisicaoCompraAnexoObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        RequisicaoCompraAnexo::observe(RequisicaoCompraAnexoObserver::class);
        RequisicaoCompraAdjudicacao::observe(RequisicaoCompraAdjudicacaoObserver::class);
        PedidoCompra::observe(PedidoCompraObserver::class);
        RecebimentoPedido::observe(RecebimentoPedidoObserver::class);
        RecebimentoPedidoParcela::observe(RecebimentoPedidoParcelaObserver::class);
        PedidoCompraPrevisaoEntrega::observe(PedidoCompraPrevisaoEntregaObserver::class);
