...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:102400'],        // 100 MB — fallback; sobrescrito por requisição em App\Http\Middleware\DefinirLimiteUploadDoTenant com o limite do plano do tenant atual
