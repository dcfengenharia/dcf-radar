...
@section('title', 'Linhas de Base — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Obras / Cronograma /</span> Linhas de Base
</h4>
...
<livewire:pages::radar.linhas-base :obra="$obraAtual" />
@endsection
