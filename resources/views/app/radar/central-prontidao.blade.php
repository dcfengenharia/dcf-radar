...
@section('title', 'Central de Prontidão — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar / Restrições /</span> Central de Prontidão
</h4>
...
<livewire:pages::radar.central-prontidao :obra="$obraAtual" />
@endsection
