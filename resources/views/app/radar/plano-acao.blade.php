...
@section('title', 'Plano de Ação — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar / Restrições /</span> Plano de Ação
</h4>
...
<livewire:pages::radar.plano-acao :obra="$obraAtual" />
@endsection
