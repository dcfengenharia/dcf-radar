...
@section('title', 'Importar Cronograma — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Obras /</span> Importar Cronograma
</h4>
...
<livewire:pages::radar.cronograma :obra="$obraAtual" />
@endsection
