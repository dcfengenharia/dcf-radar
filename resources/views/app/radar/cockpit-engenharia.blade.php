...
@section('title', 'Cockpit de Engenharia — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar /</span> Cockpit de Engenharia
</h4>
...
<livewire:pages::radar.cockpit-engenharia :obra="$obraAtual" />
@endsection
