...
@section('title', 'Relatórios de Restrições — ' . $obraAtual->name)
...
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar / Restrições /</span> Relatórios de Restrições
</h4>
...
<livewire:pages::radar.relatorios-restricoes :obra="$obraAtual" />
@endsection
