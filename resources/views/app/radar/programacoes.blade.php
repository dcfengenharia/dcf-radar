...
@section('title', 'Minhas Programações — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar /</span> Minhas Programações
</h4>
...
<livewire:pages::radar.programacoes :obra="$obraAtual" />
@endsection
