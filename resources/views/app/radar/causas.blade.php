...
@section('title', 'Dashboard de Causas — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar /</span> Dashboard de Causas
</h4>
...
<livewire:pages::radar.causas :obra="$obraAtual" />
@endsection
