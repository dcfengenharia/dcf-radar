...
@section('title', 'Inconsistências de Avanço — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar / Restrições /</span> Inconsistências de Avanço
</h4>
...
<livewire:pages::radar.inconsistencias-avanco :obra="$obraAtual" />
@endsection
