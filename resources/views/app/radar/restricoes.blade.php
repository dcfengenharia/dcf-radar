...
@section('title', 'Quadro de Restrições — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar /</span> Quadro de Restrições
</h4>
...
<livewire:pages::radar.restricoes :obra="$obraAtual" />
@endsection
