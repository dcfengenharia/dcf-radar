...
@section('title', 'Cockpit de Suprimentos — ' . $obraAtual->name)

@section('content')
<h4 class="py-3 breadcrumb-wrapper mb-2">
  <span class="text-muted fw-light">Radar /</span> Cockpit de Suprimentos
</h4>
...
<livewire:pages::radar.cockpit-suprimentos :obra="$obraAtual" />
@endsection
